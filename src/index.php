            ...
            <div class="table-responsive">
                <table class="table table-danger table-bordered" id="tbl">
                    ...
                    <tbody>
                        ...
                        $hoy = date('Y-m-d');
                        $query = mysqli_query($conexion, "SELECT p.*, t.tipo, pr.nombre FROM producto p INNER JOIN tipos t ON p.id_tipo = t.id INNER JOIN categoria pr ON p.id_presentacion = pr.id WHERE p.vencimiento != '0000-00-00' AND p.vencimiento < '$hoy'");
