...
$pdf->Cell(13, 5, utf8_decode('Nombre'), 0, 0, 'L');
$pdf->Cell(17, 5, utf8_decode('Teléfono'), 0, 0, 'L');
$pdf->Cell(18, 5, utf8_decode('Dirección'), 0, 0, 'L');
$pdf->Cell(2, 5, utf8_decode('Fecha'), 0, 1, 'L');
$pdf->SetFont('Arial', '', 7);
$pdf->Cell(4, 5, utf8_decode($datosV['id']), 0, 0, 'L');
$pdf->Cell(13, 5, utf8_decode($datosC['nombre']), 0, 0, 'L');
$pdf->Cell(17, 5, utf8_decode($datosC['telefono']), 0, 0, 'L');
$pdf->Cell(18, 5, utf8_decode($datosC['direccion']), 0, 0, 'L');
$pdf->Cell(2, 5, utf8_decode($datosV['fecha']), 0, 1, 'L');
